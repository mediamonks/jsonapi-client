...
},{}],"../../src/lib/ApiController.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  _createClass(ApiController, [{
    ...
    key: "decodeResource",
    value: function decodeResource(type, data) {
      var _this = this;
        ...
        if (field.isAttributeField()) {
          ...
          var relationshipData = _this.getRelationshipData(data, field).map(function (value) {
            if ((0, _isntnt.isNone)(value) || (0, _isntnt.isNone)(includeParam) || (0, _isntnt.isUndefined)(includeParam[name])) {
              resource[name] = value;
            } else if ((0, _isntnt.isArray)(value)) {
...
},{"isntnt":"../../node_modules/isntnt/dist/index.js","../constants/data":"../../src/constants/data.ts","../utils/data":"../../src/utils/data.ts","../utils/Result":"../../src/utils/Result.ts","./ApiEndpoint":"../../src/lib/ApiEndpoint.ts","./ApiError":"../../src/lib/ApiError.ts"}],"../../src/constants/setup.ts":[function(require,module,exports) {
"use strict";
