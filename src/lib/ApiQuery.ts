...
// export type ApiQueryIncludeParameter<R extends AnyResource> = BaseApiQueryIncludeParameters<R>
...
//   sort: Array<string>
//   filter: ApiQueryParameterValue
// }>

// export type ApiQueryParameterValue = string | number | boolean | Array<string | number>
...
// export class ApiQuery<T extends ApiQueryParameters> {
//   api: Api<any>
//   values: T
...
// const parseApiQuery = <T extends ApiQueryParameters>(api: Api<any>, values: T): string => {
//   const parameters: Array<string> = Object.keys(values)
//     .sort()
//     .flatMap((name) => {
//       switch (name) {
...
//           return parseApiQueryParameter(name, parseSortParameter(values[name]))
...
//   name: typeof jsonApiReservedParameterNames['SORT'],
//   value: Array<string> = [],
// ) => (isArray(value) && value.length ? [`${name}=${value.join(',')}`] : [])
...
// ): ReadonlyArray<string> =>
//   isSome(value)
//     ? parseApiQueryParameterValue(name, getIncludeParameter([], value) as Array<string>)
//     : EMPTY_ARRAY
...
//       | null
//       | {
//           [K in keyof T]?: BaseApiQueryIncludeParameters<BaseRelationshipResource<T[K]>>
//         }
//   : never
